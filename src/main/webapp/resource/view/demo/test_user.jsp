...
<form class="search_form" action="<%=request.getContextPath()%>/demo/test_user/query.action">
...
<div id="demo_test_user"  class="show_win">
    <form class="show_form" action="<%=request.getContextPath()%>/demo/test_user" method="post">
...
{iconCls:'icon-no', text:'关闭',handler:function(e){closeDivWindow('demo_test_user')}}
];
var dategrid_toolbar= [
{iconCls: '', handler: function(){}},
'-',
{iconCls: 'icon-add',text:'新增', handler: function(e){openDivWindow('新增demo_test_user',350,340,'icon-add',add_buttons,'demo_test_user');}},
'-',
{iconCls: 'icon-edit',text:'编辑', handler: function(e){loadShowForm(e,'demo_test_user',update_buttons,350,340,'icon-edit','编辑demo_test_user信息')}},
'-',
