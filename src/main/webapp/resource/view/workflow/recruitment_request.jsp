...
<div class="search_view" id="workflow_recruitment_request_view">
<form class="search_form" action="<%=request.getContextPath()%>/workflow/recruitment_request/query.action?requestId=<%=((User)session.getAttribute("user")).getId()%>">
...
<div id="workflow_recruitment_request"  class="show_win">
    <form class="show_form" action="<%=request.getContextPath()%>/workflow/recruitment_request" method="post">
        ...
        <table class="show_table">
            ...
            <tr><td>
                <label class="">招聘数量：</label>
                <input class="easyui-textbox" data-options="width:175,height:25,required:true" name="num"/>
            </td></tr>
            <tr><td>
                <label>招聘要求：</label>
                <input class="easyui-textbox" type="text" data-options="width:175,height:75"  name="demand"/>
                </input>
            </td></tr>
            <tr><td>
                <label>申请原因：</label>
...
'-',
{iconCls: 'icon-add',text:'新增', handler: function(e){openDivWindow('新增招聘申请',360,380,'icon-add',add_buttons,'workflow_recruitment_request');}},
'-',
...
initSearchView(id="workflow_recruitment_request_view",table_colums,"id",dategrid_toolbar);
