...
<div class="search_view" id="workflow_overtime_application_request_view">
<form class="search_form" action="<%=request.getContextPath()%>/workflow/overtime_application_request/query.action?requestId=<%=((User)session.getAttribute("user")).getId()%>">
...
<div id="workflow_overtime_application_request"  class="show_win">
    <form class="show_form" action="<%=request.getContextPath()%>/workflow/overtime_application_request" method="post">
        ...
        <table class="show_table">
            <tr><td>
                ...
                <input class="easyui-combobox search_input" data-options="
                    ...
                    width:'175px',
                    height:'25px',
                    url: '<%=request.getContextPath()%>/resource/data/overtime_type.json'"name="type"/>
            </td></tr>
            <tr><td>
...
'-',
{iconCls: 'icon-add',text:'新增', handler: function(e){openDivWindow('新增加班申请',350,340,'icon-add',add_buttons,'workflow_overtime_application_request');}},
'-',
...
var table_colums = [[
    ...
    {field:"type",title:"加班类型",width:100,align:"center",hidden:false,checkbox:false},
...
initSearchView(id="workflow_overtime_application_request_view",table_colums,"id",dategrid_toolbar);
